...
cartProductsList.addEventListener('click', (e) => {
	if (e.target.classList.contains('cart-product__delete') || e.target.classList.contains('order-product__delete')) {
...
const modal = new GraphModal({
	isOpen: (modal) => {
		...
		document.querySelector('.order-modal__quantity span').textContent = `${length} prs.`;
